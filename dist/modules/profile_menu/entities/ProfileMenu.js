...
let ProfileMenu = (_dec = (0, _typeorm.Entity)('profile_menu'), _dec2 = Reflect.metadata("design:type", Function), _dec3 = Reflect.metadata("design:paramtypes", []), _dec4 = (0, _typeorm.PrimaryColumn)({
  name: 'pme_id_s'
  ...
  name: 'pme_menu_s'
}), _dec10 = Reflect.metadata("design:type", String), _dec11 = (0, _typeorm.ManyToOne)(() => _Profile.default), _dec12 = (0, _typeorm.JoinColumn)({
  name: 'pme_profile_s'
}), _dec13 = Reflect.metadata("design:type", typeof _Profile.default === "undefined" ? Object : _Profile.default), _dec14 = (0, _typeorm.Column)({
  name: 'pme_profile_s'
  ...
  name: 'pme_updated_d'
}), _dec19 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class ProfileMenu {
  constructor() {
    ...
    _initializerDefineProperty(this, "profileRef", _descriptor4, this);
  ...
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "profileRef", [_dec11, _dec12, _dec13], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "profile", [_dec14, _dec15], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
