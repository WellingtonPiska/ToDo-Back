...
let UserCostCenter = (_dec = (0, _typeorm.Entity)('user_costcenter'), _dec2 = Reflect.metadata("design:type", Function), _dec3 = Reflect.metadata("design:paramtypes", []), _dec4 = (0, _typeorm.PrimaryColumn)({
  name: 'ucc_id_s'
  ...
  name: 'ucc_costcenter_s'
}), _dec10 = Reflect.metadata("design:type", String), _dec11 = (0, _typeorm.ManyToOne)(() => _User.default), _dec12 = (0, _typeorm.JoinColumn)({
  name: 'ucc_user_s'
}), _dec13 = Reflect.metadata("design:type", typeof _User.default === "undefined" ? Object : _User.default), _dec14 = (0, _typeorm.Column)({
  name: 'ucc_user_s'
  ...
  name: 'ucc_updated_d'
}), _dec19 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class UserCostCenter {
  constructor() {
    ...
    _initializerDefineProperty(this, "userRef", _descriptor4, this);
  ...
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "userRef", [_dec11, _dec12, _dec13], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "user", [_dec14, _dec15], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
